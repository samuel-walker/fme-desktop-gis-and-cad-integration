...
![](../DesktopBasic1Basics/Images/Img1.021.RunningWorkspace1.png)

Alternatively, look under Run on the menubar:

![](../DesktopBasic1Basics/Images/Img1.022.RunningWorkspace2.png)

The same toolbar options appear on both the menubar and toolbar. Notice the shortcut option F5 can be used instead: 

![](../DesktopBasic1Basics/Images/Img1.023.RunningWorkspace3.png)
...
![](../DesktopBasic1Basics/Images/Img1.024.TranslationResults.png)
