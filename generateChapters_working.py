...
with open('urls.csv', 'r') as csvfile: # open csv
...
# generate summary.md
summary = open("summary.md","w") # open summary.md to md_write
summary.write("# Summary \n\n")
for row in summary:
    * [About this Document](CADGIS0About/0.00.About.md)

with open('summary.csv', 'r') as csvfile: # open csv
    data = csv.reader(csvfile, delimiter=',') # define csvreader
    for row in data: # iterate on urls to generate chapters
